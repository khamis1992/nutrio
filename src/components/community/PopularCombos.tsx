          ...
          <div className="flex gap-3 pr-5">
            ...
            <motion.div key={combo.id} whileTap={{ scale: 0.975 }} className="group w-[130px] shrink-0 overflow-hidden rounded-xl bg-white shadow-[0_1px_3px_rgba(15,23,42,0.04)] ring-1 ring-slate-100 hover:shadow-[0_4px_12px_rgba(15,23,42,0.08)] transition-shadow">
              ...
              <div className="p-3 space-y-2">
                ...
                <button className="w-full h-9 rounded-full bg-slate-50 text-[12px] font-extrabold text-slate-600 hover:bg-slate-100 transition-colors inline-flex items-center justify-center gap-1" onClick={()=>handleTryCombo(combo)}>{t("community_try_combo")} <ChevronRight className="h-3.5 w-3.5" /></button>
              </div>
            </motion.div>
          ))}
          </div>
