...
import { Shield, Store, Users, ShoppingBag, BarChart3, CreditCard, Settings, Download, Wallet, Tag, Ticket, Headphones, Bell } from "lucide-react";
...
const navItems = [
  ...
  { icon: Bell, label: "Notify", to: "/admin/notifications" },
