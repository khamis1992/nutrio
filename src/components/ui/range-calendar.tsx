    ...
    <AriaCalendarCell
      className={composeRenderProps(className, (className, renderProps) =>
        cn(
          ...
          /* Selection start / end — solid primary circle */
          renderProps.isSelected &&
            (renderProps.isSelectionStart || renderProps.isSelectionEnd || !isRange) &&
            "rounded-full bg-primary text-primary-foreground",
          /* In-range cells (between start and end) — light band, override bg-primary with !important */
          renderProps.isSelected &&
            isRange &&
            !renderProps.isSelectionStart &&
            !renderProps.isSelectionEnd &&
            "!rounded-none !bg-primary/20 !text-foreground",
          /* Outside Month */
          renderProps.isOutsideMonth &&
            "text-muted-foreground opacity-50 data-[selected]:bg-primary/5 data-[selected]:text-muted-foreground data-[selected]:opacity-30",
          /* Current Date (today) */
