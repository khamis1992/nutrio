      ...
      <div className="flex-1 overflow-y-auto px-6 pt-6 pb-6 relative">
        ...
        <form id="signin-form" onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-5">
          ...
          <div className="flex flex-col gap-4 mt-2">
            <button type="button" className="h-14 rounded-2xl bg-white shadow-[0_1px_3px_rgba(15,23,42,0.04)] ring-1 ring-slate-100 flex items-center justify-center gap-3">
              ...
              <span className="text-[16px] font-medium text-slate-800">Continue with Google</span>
            </button>
            <button type="button" className="h-14 rounded-2xl bg-white shadow-[0_1px_3px_rgba(15,23,42,0.04)] ring-1 ring-slate-100 flex items-center justify-center gap-3">
              ...
              <span className="text-[16px] font-medium text-slate-800">Continue with Apple</span>
            </button>
          </div>
