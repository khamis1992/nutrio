      ...
      <Card className="bg-gradient-to-br from-primary/10 to-primary/5 border-border">
        <CardContent className="p-6">
          ...
          <button
            ...
            className="w-full border border-primary/30 text-primary hover:bg-primary/10 px-4 py-2 rounded-md text-sm font-medium transition-colors"
          >
            Edit Profile
          </button>
        </CardContent>
      ...
      <Card className="bg-gradient-to-br from-warning/10 to-warning/5 border-border">
        <CardContent className="p-6">
          ...
          <button
            ...
            className="w-full border border-warning/30 text-warning hover:bg-warning/10 px-4 py-2 rounded-md text-sm font-medium transition-colors"
          >
            Add Entry
          </button>
        </CardContent>
